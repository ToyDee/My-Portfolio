            ...
            <form className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <input
                    id="name"
                    type="text"
                    className="w-full bg-neutral-950 border border-neutral-800 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-teal-400 focus:shadow-[0_0_0_3px_rgba(45,212,191,0.15)] transition-all duration-300"
              ...
              <div className="space-y-2">
                ...
                <textarea
                  id="message"
                  rows={4}
                  className="w-full bg-neutral-950 border border-neutral-800 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-teal-400 focus:shadow-[0_0_0_3px_rgba(45,212,191,0.15)] transition-all duration-300 resize-none"
              ...
              <button
                type="submit"
                className="shine-hover group w-full bg-teal-400 text-black font-bold py-4 rounded-xl hover:bg-teal-300 transition-all duration-300 flex items-center justify-center gap-2 active:scale-[0.98]"
              >
